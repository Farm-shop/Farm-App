...
//        EditText phone = findViewById(R.id.passWordInSignUpPage);
//        EditText location = findViewById(R.id.passWordInSignUpPage);
//        EditText lattudi = findViewById(R.id.passWordInSignUpPage);
//        EditText lang = findViewById(R.id.passWordInSignUpPage);
//
//
